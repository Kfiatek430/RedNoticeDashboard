<script lang="ts">
    ...
    class Criminal {
        ...
        async fetchCriminalData(href: string) {
            ...
            this.dateOfBirth = new Date(data.date_of_birth).toLocaleDateString(
                "en-GB",
...
<div class="w-full">
    {#if dataFetched}
        <h1
            class="text-3xl sm:text-4xl md:text-5xl text-center text-white mb-5"
        >
            {criminal.name + " " + criminal.forename}
        </h1>
        <div
            class="flex flex-col md:flex-row items-start justify-center gap-5 p-4 text-white w-full"
        >
            <aside class="w-full md:w-1/3 flex flex-col gap-2 p-4 font-bold">
                <img
                    class="rounded-lg w-full md:w-64"
                    src={criminal.profilePicturePath || defaultProfilePicture}
                    alt=""
                    draggable="false"
                />
                <div class="flex items-center gap-3">
                    ...
                    {#each criminal.nationalities as nationality}
                        <div class="relative group">
                            <img
                                src={`https://www.flagsapi.com/${nationality}/flat/24.png`}
                                alt=""
                                draggable="false"
                                class="cursor-pointer"
                            />
                            <span
                                class="absolute bottom-5 left-1/2 transform -translate-x-1/2 hidden group-hover:block bg-black text-white text-xs rounded px-2 py-1 whitespace-nowrap min-w-max"
                            >
                ...
                {#if criminal.countryOfBirthId}
                    <div class="flex items-center gap-3">
                        ...
                        <div class="relative group">
                            <img
                                src={`https://www.flagsapi.com/${criminal.countryOfBirthId}/flat/24.png`}
                                alt=""
                                draggable="false"
                            />
                            <span
                                class="absolute bottom-5 left-1/2 transform -translate-x-1/2 hidden group-hover:block bg-black text-white text-xs rounded px-2 py-1 whitespace-nowrap min-w-max"
                            >
                                {countryMap[criminal.countryOfBirthId] ||
                                    criminal.countryOfBirthId}
                            </span>
                        </div>
                    </div>
                {/if}
                ...
                <p>
                    Date of birth: <span class="font-normal"
                        >{criminal.dateOfBirth}</span
                    >
                </p>

                {#if criminal.placeOfBirth}
                    <p>
                        Place of birth: <span class="font-normal"
                            >{criminal.placeOfBirth}</span
                        >
                    </p>
                {/if}
                ...
                {#if criminal.height}
                    <p>
                        Height: <span class="font-normal"
                            >{criminal.height} cm</span
                        >
                    </p>
                {/if}
                ...
                {#if criminal.weight}
                    <p>
                        Weight: <span class="font-normal"
                            >{criminal.weight} kg</span
                        >
                    </p>
                {/if}
                ...
                {#if criminal.eyesColorsId}
                    <p>
                        Eyes: <span class="font-normal"
                            >{criminal.eyesColorsId}</span
                        >
                    </p>
                {/if}
                ...
                {#if criminal.hairsId}
                    <p>
                        Hairs: <span class="font-normal"
                            >{criminal.hairsId}</span
                        >
                    </p>
                {/if}
            </aside>
            <div
                class="w-full md:w-2/3 h-full flex flex-col gap-2 justify-start p-4"
            >
